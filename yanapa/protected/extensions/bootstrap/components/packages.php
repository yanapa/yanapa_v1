...
return array(
	...
	// DEVINF 14/02/2014 - temporary fix to preload jquery-ui.js before bootstrap javascripts, to avoid conflicts (for instance, with tooltips, datepickers etc)	
	'sjquery-ui' => array(									//DEVINF
        'js' => array('jquery-ui.min.js'),					//DEVINF
        'depends' => array('jquery'),						//DEVINF
    ),	//DEVINF
	// DEVINF 28/02/2014 - custom yii-boostrap css
	'sbootstrap-yii' => array(								//DEVINF
		'baseUrl' => $this->getAssetsUrl(),					//DEVINF
		'css' => array('css/sbootstrap-yii.css'),			//DEVINF
    ),	//DEVINF
